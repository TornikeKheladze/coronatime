...
class AuthTest extends TestCase
{
	...
	{
		$response = $this->post('/{lang}/login', ['password'=>'my-password']);
	...
	{
		$response = $this->post('/{lang}/login', ['name_mail'=>'myemail@gmail.com']);
